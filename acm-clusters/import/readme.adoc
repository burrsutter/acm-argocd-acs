...
----
cm attach cluster blr1 --cluster-kubeconfig=/Users/burr/xKS/.kubeconfig/doks1-config --context=do-blr1-blr1-kubernetes
----

----
cm attach cluster gke1 --cluster-kubeconfig=/Users/burr/xKS/.kubeconfig/gke1-config --context=gke_alohaburr_us-central1-c_gke1
----

#### Extras

----
kubectl label managedcluster ams3 cloud=Alibaba
kubectl label managedcluster blr1 cloud=Azure
