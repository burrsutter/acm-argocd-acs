...
First add a label to the local-cluster managed cluster
...
----
kubectl get managedcluster -l cluster.open-cluster-management.io/clusterset=all-openshift-clusters
