...
Scale up MachineSets to have enough cores to load everything in.   Just click on the name of the machineset and +1. If you are monitoring your Azure, AWS or GCP console you will see a new VM spring to life.  It takes several minutes to provison the new worker node.
