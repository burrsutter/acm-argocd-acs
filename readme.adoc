...
A job named create-cluster-init-bundle makes the single Central cluster a SecuredCluster as well
...
Note: The installation path below does NOT work at this time
...
Click on Create Central and Create again
...
Give it the name "local-cluster" and the Central Endpoint comes from
...
kubectl get pods -n stackrox
NAME                                 READY   STATUS    RESTARTS      AGE
admission-control-6f6fd7c7f7-2xlf5   0/1     Running   0             2m19s
admission-control-6f6fd7c7f7-69xbj   0/1     Running   0             2m19s
admission-control-6f6fd7c7f7-gjhrf   0/1     Running   0             2m19s
central-6b96668d45-9rsqj             1/1     Running   0             2d18h
collector-444p8                      2/2     Running   0             2m19s
collector-7rzdg                      2/2     Running   0             2m19s
collector-85nc7                      2/2     Running   0             2m19s
collector-kpfrk                      2/2     Running   0             2m19s
collector-qrhkb                      2/2     Running   0             2m19s
collector-r8p6b                      2/2     Running   0             2m19s
collector-rxwhz                      2/2     Running   0             2m19s
collector-vsjnw                      2/2     Running   0             2m19s
scanner-7d77d75f6c-vhs2q             1/1     Running   0             2d18h
scanner-7d77d75f6c-zw2dw             1/1     Running   0             2d18h
scanner-db-77dd49d98-bn7x9           1/1     Running   0             2d18h
sensor-7f4b4b9bf4-cn4bg              0/1     Error     4 (85s ago)   2m19s
----

Back on ACS Central UI, Go to Compliance

image::./images/acs-19.png[][Go to Compliance]
